...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const serviceId = 'service_893l5it';
    const templateId = 'template_alsjb3w';
    const publicKey = 'kTAYTAH5tGjboiBl0';
        ...
        <div className="flex flex-col lg:flex-row px-4 lg:px-20 gap-8 max-w-screen-xl w-full mx-auto mt-14 pb-20">
          ...
          >
            ...
            <div className="card-body items-center text-center pb-5 ">
              ...
              <div className="card-actions">
                <a href='mailto: FMAUTOS@GMAIL.COM' _blank className="hover:text-yellow-400 font-bold">
                  FMAUTOS@GMAIL.COM
                </a>
              </div>
            </div>
            ...
            <div className="card-body items-center text-center pb-5">
              ...
              <div className="card-actions">
                <h1 className="font-bold">
                  HOUSE 4, ROAD 1 UTTARA,DHAKA,1219.
                </h1>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="card-body items-center text-center">
              ...
              <p className="text-white font-bold">+8801951712991</p>
              <div className="card-actions">
                <h1 className="font-bold">+8801517005869</h1>
              </div>
            </div>
          </div>
        </div>
