...
<div className="text-[#d1d6d8] flex flex-col justify-start items-start w-full gap-2">
            <select
              ...
              style={{ backgroundColor: "hsl(244, 20%, 14%)" }}
              name="driveType" // Match the input name to the state property
              value={searchCriteria.priceRange} // Set value from state
              onChange={handleSearchCriteriaChange}
            >
              <option value="" disabled selected>
                Price Range
              </option>
              <option value="4WD">5 lac to 10 lac</option>
              <option value="AWD">11 lac to 15 lac</option>
              <option value="FWD">16 lac to 20 lac </option>
              <option value="RWD">20 lac to 30 lac</option>
              <option value="6WD">30 lac to 40 lac</option>
              <option value="6WD">40 lac to 50 lac</option>
              <option value="6WD">50 lac +</option>
              {" "}
              {/* New drive type */}
