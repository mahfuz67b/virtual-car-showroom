  ...
  return (
    <div className="container my-5 py-10 lg:py-40 pr-[50px]">
      ...
      <p className=" text-justify mb-4 pb-6 lg:pb-10">
        ...
        using the website accordingly. FM AUTOS company name only grants use
      ...
      <p className=" text-justify mb-4 pb-6 lg:pb-10">
        ...
        years of age and you may legally adhere to this Agreement. FM AUTOS
      ...
      <p className=" text-justify mb-4 pb-6 lg:pb-10">
        FM AUTOS is not liable for any damages that may occur to you as a
        result of your misuse of our website. FM AUTOS reserves the right to
        ...
        an understanding between FM AUTOS and the user, and this supersedes and
