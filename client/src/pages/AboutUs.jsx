          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="lg:max-w-md">
              ...
              <p className="px-4 mb-10 md:w-full text-sm lg:w-full leading-6 text-white dark:text-gray-400">
                Welcome to FM Autos, where automotive excellence meets a legacy of
                precision and innovation. At FM Autos, were not just crafting cars;
                ...
                FM Autos has consistently set the benchmark for performance, design,
                and cutting-edge technology in the automotive industry.
                <br />
                <br />
                Our journey is rooted in a commitment to pushing boundaries and
                challenging the status quo. At the core of FM Autos is a team of
