...
import { carAdd } from "../Actions/car";
...
function CarAddForm() {
    ...
    <div>
      ...
      <dialog id="my_modal_4" className="modal">
        <div className="modal-box w-11/12 max-w-5xl">
          <h3 className="text-center text-2xl font-bold">Add a New Car</h3>
        ...
        />
        <label htmlFor="airlock" className="text-black">
          Air Lock
        </label>
      </div>
  ...
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="power-steering" className="text-black">
      Power Steering
    </label>
</div>
  ...
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="air-conditioner" className="text-black">
      Air Conditioner
    </label>
</div>
  ...
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="navigationg" className="text-black">
      Navigation
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="anti-lock-brake-system" className="text-black">
    Anti Lock Brakes
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="leather-seats" className="text-black">
    Leather Seats
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="tv" className="text-black">
     TV
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="fog-lights" className="text-black">
     Fog Lights
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="alloy-wheels" className="text-black">
     Alloy Wheels
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="grill-guard" className="text-black">
    Grill Guard
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="power-windows" className="text-black">
    Power Window
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="roof-rails" className="text-black">
      Roof Rails
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="dual-air-bugs" className="text-black">
      Dual Air Bugs
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="sun-roof" className="text-black">
      Sun Roof
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="rear-spoilers" className="text-black">
      Rear Spoilers
    </label>
</div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="black-tire" className="text-black">
      Black Tire
    </label>
</div>
<div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="key-less-entry" className="text-black">
      Keyless Entry
    </label>
  </div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="central-locking" className="text-black">
      Central Locking
    </label>
  </div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="cd-player" className="text-black">
      CD Player
    </label>
  </div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="abs" className="text-black">
      ABS
    </label>
  </div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="ac-front" className="text-black">
      A/C Front
    </label>
  </div>
  <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="ac-rear" className="text-black">
      A/C Rear
    </label>
  </div>
